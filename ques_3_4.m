...
fname = [];
if problem_idx == 1
    fname = 'results_3_4_1_trajectory.txt';
elseif problem_idx == 2
    fname = 'results_3_4_2_trajectory.txt'
end
...
plot(error_vec);
if problem_idx == 1
    saveas(gcf,'results_q_3_4_1_error_plot.png');
elseif problem_idx == 2
    saveas(gcf,'results_q_3_4_2_error_plot.png');
end